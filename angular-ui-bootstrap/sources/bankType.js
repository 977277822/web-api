...
(function(){
    ...
    {
        $card_8 = $card.substring(0, 8);
        if ($bankList[$card_8]) {
            return $bankList[$card_8];
        }
        $card_6 = $card.substring(0, 6);
        if ($bankList[$card_6]) {
            return $bankList[$card_6];
        }
        $card_5 = $card.substring( 0, 5);
        if ($bankList[$card_5]) {
            return $bankList[$card_5];
        }
        $card_4 = $card.substring( 0, 4);
        if ($bankList[$card_4]) {
    ...
    //获取银行卡对应的银行及卡类型
    //var msg = bankInfo('6225750123456789',$bankList);
...
(function(){
    var map = {};
    for(var p in $bankList){
        map[$bankList[p].split("-")[0]] = 0;
    }
